use <../Library/vehicle_parts.scad>
$fa=1;
$fs=0.4;
...
body(base_length=base_length, top_length=top_length, top_offset=top_offset,  front_bumper=front_bumper, rear_bumper=rear_bumper);
// Front left wheel 
