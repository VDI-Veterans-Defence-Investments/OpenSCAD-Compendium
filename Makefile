...
AMU_LIB_PATH        := /usr/local/share/openscad-amu/v3.5

# source paths
#AMU_TOOL_PREFIX    := /home/dave/OpenSCAD-Compendium/cache/openscad-amu/build/master/Linux/src/
#AMU_LIB_PATH       := /home/dave/OpenSCAD-Compendium/cache/openscad-amu/build/master/Linux/../../../share
...
#------------------------------------------------------------------------------#
project_name        := OpenSCAD-Compendium
